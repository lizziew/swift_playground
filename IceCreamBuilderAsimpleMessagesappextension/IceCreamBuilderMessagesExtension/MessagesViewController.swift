...
class MessagesViewController: MSMessagesAppViewController {
    ...
    private func presentViewController(for conversation: MSConversation, with presentationStyle: MSMessagesAppPresentationStyle) {
        ...
        if presentationStyle == .compact {
            ...
            print("ajdflkajskldfjlkasdjflajdslkfjakljflkjsdlkf")
            /*
    ...
    private func composeMessage(with iceCream: IceCream, caption: String, session: MSSession? = nil) -> MSMessage {
    ...
    func buildIceCreamViewController(_ controller: BuildIceCreamViewController, didSelect iceCreamPart: IceCreamPart) {
        ...
        */
        ...
        if let base = iceCreamPart as? Base {
            ...
            changeDescription = NSLocalizedString("We started creating an ice cream", comment: "")
        }
            ...
            changeDescription = NSLocalizedString("We added scoops to an ice cream", comment: "")
        }
        else {
